...
LABEL org.opencontainers.image.authors="FNNDSC <dev@babyMRI.org>" \
      org.opencontainers.image.title="A bulk processor" \
      org.opencontainers.image.description="A ChRIS plugin to do bulk process some input files"

ARG SRCDIR=/usr/local/src/bulkprocess
WORKDIR ${SRCDIR}
